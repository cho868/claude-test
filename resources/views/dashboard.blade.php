            ...
            @php
                $groups = [
                    '🎮 ゲーム' => [
                        ...
                        ['social.index', '📋', 'ソシャゲ日課', 'リセット前に通知'],
                        ['pokemon.index', '🔴', 'ポケモン計算', 'ダメージ計算機'],
                        ['arcade.index', '👾', 'ミニゲーム', '反射神経/数字タッチ'],
                        ['monsters.index', '🐣', 'モンスター', '育成/共有ボス/対戦'],
                    ],
                    '💪 からだ' => [
                    ...
                    '💰 おかね' => [
                        ['expenses.index', '💰', '家計簿', '収支記録・予算・推移'],
                    ],
                    '🧰 ツール' => [
                        ['tools.index', '🧰', 'ツール一覧', '全ツールをここから'],
                        ['tools.image', '🖼️', '画像変換', '形式変換/透明化/PDF'],
                        ['tools.text', '🔤', '文字変換', '装飾フォント/エンコード'],
                        ['tools.qr', '🔳', 'QRコード作成', 'URL/Wi-Fi/メール'],
                        ['tools.ogp', '🔍', 'OGP確認', 'SNSでの見え方'],
